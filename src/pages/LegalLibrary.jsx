...
<div class="title-block">
  ...
  <div class="meta">Generated by Klaro AI with live law search · ${dateStr}</div>
</div>
${sectionsHtml}
<div class="disclaimer">
  This guide is AI-generated for informational purposes only and does not constitute legal advice.
      ...
      <div className="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800">
        <div className="max-w-5xl mx-auto px-5 py-8">
          ...
          <div className="flex justify-center">
            <div>
              <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1.5">{t('library.countryLabel')}</label>
              <select
                value={country}
              ...
              <div>
                ...
                {guide && (
                  <p className="text-xs text-gray-400 dark:text-gray-500">
                    {guide.countryName} · AI-generated with live law search · {new Date(guide.generatedAt).toLocaleDateString('en-GB')}
                  </p>
                )}
                {loading && (
                  <p className="text-xs text-gray-400 dark:text-gray-500">
