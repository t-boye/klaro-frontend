...
const TR = {
  en: {
    ...
    devBio1: 'Passionate about technology, innovation, and digital growth. Emmanuel built Klaro to bridge the gap between complex legal language and the everyday African, solving a problem he witnessed firsthand in his own family and community.',
  ...
  fr: {
    ...
    devBio1: "Passionné par la technologie, l'innovation et la croissance numérique. Emmanuel a construit Klaro pour combler le fossé entre le langage juridique complexe et l'Africain ordinaire, résolvant un problème qu'il a été témoin dans sa propre famille et communauté.",
